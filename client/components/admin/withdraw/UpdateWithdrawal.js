...
import { updateWithdraw } from "../../../util/auth";
import Notification from "../../UI/notification/Notification";
import Spinner from "../../UI/spinner/Spinner";

export default function UpdateWithdrawal({ setShow, withdraw }) {
  if (!withdraw) {
    return <Spinner />;
  }
  ...
  async function approveHandler(e) {
    ...
    try {
      setLoading(true);
      const response = await updateWithdraw(withdraw._id, token, data);
      setMessage({
        title: "success",
        text: "successful",
        status: "success",
