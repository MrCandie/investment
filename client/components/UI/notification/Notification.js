...
export default function Notification({ title, text, status, setShow }) {
  return (
    <Fragment>
      ...
      <div className="bg-white z-50 flex flex-col space-y-6 rounded-lg shadow-xl p-10 w-[90%] lg:w-[40%] md:w-[60%] absolute top-60 lg:top-20 left-5 md:left-[20%] lg:left-[30%]">
